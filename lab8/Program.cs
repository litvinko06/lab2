public class Program
{
    ...
    static void AddNewItem()
    {
        ...
        if (int.TryParse(name, out int amount))
        {
            Console.Write("Назва товару не повинна бути числом.");
            return;
        }
        if (name.Length < 2)
        {
            Console.Write("Назва товару повинна бути хоча б більше одного символу.");
            return;
        }
        ...
        {
            Console.Write("Кількість повинна бути числом.");
            return;
        }
